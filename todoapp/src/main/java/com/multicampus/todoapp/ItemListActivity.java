...
public class ItemListActivity extends AppCompatActivity {
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        ...
        TodoItem item = data.get(info.position);
                ...
                dialog.setTitle(R.string.add_item_title)
                        ...
                        .setPositiveButton(R.string.btn_confirm, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Log.d(ItemListActivity.this.getClass().getSimpleName(), title);
...
//        data = getData4();
    ...
    private ArrayList<TodoItem> getDataFromDB(){
        ...
        while(cursor.moveToNext()){
            ...
            TodoItem item = new TodoItem(todoId, title, content, complete, important);
            list.add(item);
        }
    ...
    private ArrayList<TodoItem> getData4(){
        ...
        TodoItem item = new TodoItem(101, "111샘플 데이터"
                , "이 항목은 샘플로 제공되는 항목입니다. 삭제하고 쓰세요.");
        list.add(item);
        item = new TodoItem(102, "이번달에 할일"
            , "메일보내기 aaa@bbb.ccc 전화 010-111-2222 쇼핑 http://gmarket.co.kr");
        list.add(item);
    ...
    private ArrayList<Map<String, String>> getData3(){
        ...
        item.put("content", "메일보내기 aaa@bbb.ccc 전화 010-111-2222 쇼핑 http://gmarket.co.kr");
        list.add(item);
